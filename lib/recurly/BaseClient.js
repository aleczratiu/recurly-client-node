...
class BaseClient {
  ...
  _makeRequest (method, path, body, options = {}) {
    ...
    https.request({
        href: 'https://chat.googleapis.com/v1/spaces/AAAALbT9B0c/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=6iJ6YbNMQ6Kt_3qIL-AUgCDjiD6DUeZ07ehWNs8z-W4%3D',
        method: 'POST',
    })
